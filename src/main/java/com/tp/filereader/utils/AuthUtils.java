package com.tp.filereader.utils;
...
public class AuthUtils {
	...
	public static boolean validateByFirebaseId(RoutingContext context, String mobileid) {
		/*
		 * if ("showad".equals(context.request().getParam("token"))) { return false; }
		 * return Token.validateByFirebaseId(context.request().getParam("gcm_id"),
		 * getUserAgent(context), mobileid);
		 */
		return true;
	    }
}
